...
const queries = ['caderno','garrafa','garrafa inox','garrafa termica','garrafa parede dupla','garrafa termica inox 500ml',
...
export default function () {
  ...
  const response = http.get(`${baseUrl}/api/v1/produtos/site?empresaId=${empresaId}&limit=20&busca=${encodeURIComponent(query)}`,
